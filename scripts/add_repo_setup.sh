...
ARCH="x86_64"
REPO_SERVER="mirror.reposerv.domain"
...
EOF
        ...
        mkdir -p "$WEB_BASE/$ver/$repo/"
        ln -s "$MIRROR_BASE/$ver/$repo" "$WEB_BASE/$ver/$repo/$ARCH"
...
ln -s "$MIRROR_BASE/$ver" "$WEB_BASE/$ver"
done
